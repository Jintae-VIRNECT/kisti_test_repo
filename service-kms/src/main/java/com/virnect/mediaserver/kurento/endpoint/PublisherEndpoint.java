...
import com.virnect.mediaserver.core.MediaOptions;
...
public class PublisherEndpoint extends MediaEndpoint {
	...
	public PublisherEndpoint(EndpointType endpointType, KurentoParticipant owner, String endpointName,
                             MediaPipeline pipeline, MediaServerProperties mediaServerProperties, PassThrough passThru) {
		super(endpointType, owner, endpointName, pipeline, mediaServerProperties, log);
	...
	public synchronized String publish(SdpType sdpType, String sdpString, boolean doLoopback) {
		...
		case OFFER:
			...
			break;
		default:
			throw new RemoteServiceException(Code.MEDIA_SDP_ERROR_CODE, "Sdp type not supported: " + sdpType);
		}
		gatherCandidates();
		return sdpResponse;
	}
	 ...
	 * @throws RemoteServiceException if thrown, the media element was not added
	 */
	public String apply(GenericMediaElement shaper) throws RemoteServiceException {
	 ...
	 * @throws RemoteServiceException if thrown, the media element was not added
	 */
	public synchronized String apply(GenericMediaElement shaper, MediaType type) throws RemoteServiceException {
	 ...
	 * @throws RemoteServiceException if thrown, the media element was not removed
	 */
	public synchronized void revert(MediaElement shaper) throws RemoteServiceException {
		revert(shaper, true);
	}

	public synchronized void revert(MediaElement shaper, boolean releaseElement) throws RemoteServiceException {
		final String elementId = shaper.getId();
		if (!elements.containsKey(elementId)) {
			throw new RemoteServiceException(Code.MEDIA_ENDPOINT_ERROR_CODE,
	...
	public JsonElement execMethod(String method, JsonObject params) throws RemoteServiceException {
