...
public class Session implements SessionInterface {
	...
	public Session(Session previousSession) {
		...
		this.mediaServerProperties = previousSession.mediaServerProperties;
		this.recordingManager = previousSession.recordingManager;
		this.tokens = previousSession.tokens;
	}

	public Session(String sessionId, SessionProperties sessionProperties, MediaServerProperties mediaServerProperties,
	...
	protected void checkClosed() {
		if (isClosed()) {
			throw new RemoteServiceException(Code.ROOM_CLOSED_ERROR_CODE, "The session '" + sessionId + "' is closed");
		}
	}
