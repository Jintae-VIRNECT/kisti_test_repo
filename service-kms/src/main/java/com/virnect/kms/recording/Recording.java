...
package com.virnect.kms.recording;
...
public class Recording {
	...
	private com.virnect.java.client.Recording.Status status;
	...
	public Recording(String sessionId, String id, RecordingProperties recordingProperties) {
		...
		this.id = id;
		this.status = com.virnect.java.client.Recording.Status.started;
	...
	public Recording(JsonObject json) {
		...
		this.status = com.virnect.java.client.Recording.Status.valueOf(json.get("status").getAsString());

		com.virnect.java.client.Recording.OutputMode outputMode = com.virnect.java.client.Recording.OutputMode
	...
	public com.virnect.java.client.Recording.Status getStatus() {
		return status;
	}

	public void setStatus(com.virnect.java.client.Recording.Status status) {
		this.status = status;
	}
	...
	public com.virnect.java.client.Recording.OutputMode getOutputMode() {
