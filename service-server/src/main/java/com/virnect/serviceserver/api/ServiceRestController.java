...
public class ServiceRestController {
   ...
   /* @ApiOperation(value = "Send Signal to a Session", notes = "특정 세션의 접속 사용자 에게 커스텀 데이터를 보내는 API 입니다.")
    ...
    @ApiOperation(value = "Load Remote Service Information", notes = "원격협업 서비스 서버 설정을 호출하는 API 입니다.")
    @GetMapping(value = "/dummy/config")
    public ResponseEntity<ApiResponse<String>> getRemoteServiceConfigurationDummy() {
