...
public class FileRestController {
	...
	public ResponseEntity<ApiResponse<FileUploadResponse>> fileUploadRequestHandler(
		...
		FileUploadResponse responseData = fileService.uploadFile(fileUploadRequest);
	...
	public ResponseEntity<ApiResponse<FileUploadResponse>> recordFileUploadRequestHandler(
		...
		if (!remoteStorageProperties.isEnabled()) {
			throw new RemoteServiceException(ErrorCode.ERR_STORAGE_NOT_SUPPORTED);
		}
		FileUploadResponse responseData = fileService.uploadRecordFile(recordFileUploadRequest);
		return ResponseEntity.ok(new ApiResponse<>(responseData));
	}
	...
	public ResponseEntity<ApiResponse<RoomProfileUpdateResponse>> profileUploadRequestHandler(
		...
		RoomProfileUpdateResponse responseData = fileService.profileUpload(
			workspaceId,
			sessionId,
	...
	public ResponseEntity<ApiResponse<ResultResponse>> profileDeleteRequestHandler(
		...
		ResultResponse responseData = fileService.deleteProfile(workspaceId, sessionId);
		return ResponseEntity.ok(new ApiResponse<>(responseData));
	}
	...
	public ResponseEntity<ApiResponse<FilePreSignedResponse>> fileDownloadUrlRequestHandler(
		...
		FilePreSignedResponse responseData = fileService.downloadFileUrl(
			workspaceId,
			sessionId,
			userId,
			objectName
	...
	public ResponseEntity<ApiResponse<FilePreSignedResponse>> recordFileDownloadUrlRequestHandler(
		...
		FilePreSignedResponse responseData = fileService.downloadRecordFileUrl(
			workspaceId,
			sessionId,
			userId,
			objectName
	...
	public ResponseEntity<ApiResponse<FileInfoListResponse>> getFileList(
		...
		FileInfoListResponse responseData = fileService.getFileInfoList(
			workspaceId,
			sessionId,
			deleted,
	...
	public ResponseEntity<ApiResponse<FileDetailInfoListResponse>> getDetailFileList(
		...
		FileDetailInfoListResponse responseData = fileService.getRecordFileInfoList(
			workspaceId,
			sessionId,
			userId,
			deleted,
	...
	public ResponseEntity<ApiResponse<FileDeleteResponse>> deleteFileRequestHandler(
		...
		FileDeleteResponse responseData = fileService.removeFile(
			workspaceId,
			sessionId,
			userId,
			objectName
	...
	public ResponseEntity<ApiResponse<String>> fileDownloadUrlRequestHandler(
		...
		String responseData = fileService.downloadGuideFileUrl(objectName);
		return ResponseEntity.ok(new ApiResponse<>(responseData));
	}
	...
	public ResponseEntity<ApiResponse<ShareFileUploadResponse>> shareFileUploadRequestHandler(
		...
		ShareFileUploadResponse responseData = fileService.uploadShareFile(
			fileUploadRequest, httpServletRequest, fileType);
		return ResponseEntity.ok(new ApiResponse<>(responseData));
	}
	...
	public ResponseEntity<ApiResponse<ShareFileInfoListResponse>> getShareFileList(
		...
		ShareFileInfoListResponse responseData = fileService.getShareFileInfoList(
			workspaceId,
			sessionId,
			paging,
			pageRequest.ofSortBy(),
	...
	public ResponseEntity<ApiResponse<FileDeleteResponse>> deleteShareFileRequestHandler(
		...
		FileDeleteResponse responseData = fileService.removeShareFile(
			workspaceId,
			sessionId,
			leaderUserId,
			objectName
	...
	public ResponseEntity<ApiResponse<FileDeleteResponse>> deleteShareFilesRequestHandler(
		...
		FileDeleteResponse responseData = fileService.removeShareFiles(
			workspaceId,
			sessionId,
			leaderUserId
		);
	...
	public ResponseEntity<ApiResponse<FileStorageInfoResponse>> checkRemoteStorageCapacity(
		...
		FileStorageInfoResponse responseData = fileService.checkRemoteStorageCapacity(workspaceId);
		return ResponseEntity.ok(new ApiResponse<>(responseData));
	}
}