...
public class CompanyRestController {
	...
	public ResponseEntity<ApiResponse<CompanyResponse>> createCompanyRequestHandler(
		...
		CompanyResponse responseData = companyService.createCompany(companyRequest);
	...
	public ResponseEntity<ApiResponse<CompanyResponse>> updateCompanyRequestHandler(
		...
		CompanyResponse responseData = companyService.updateCompany(companyRequest);
		return ResponseEntity.ok(new ApiResponse<>(responseData));
	}
	...
	public ResponseEntity<ApiResponse<CompanyInfoResponse>> getCompanyInfoRequestHandler(
		...
		CompanyInfoResponse responseData = companyService.getCompanyInfoByCompanyCode(
			workspaceId,
			userId,
			companyCode,
			policyLocation
