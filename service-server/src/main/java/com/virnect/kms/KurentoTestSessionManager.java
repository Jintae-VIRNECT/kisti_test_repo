...
import com.virnect.mediaserver.kurento.core.*;
import com.virnect.mediaserver.kurento.endpoint.KurentoFilter;
import com.virnect.mediaserver.kurento.endpoint.PublisherEndpoint;
import com.virnect.mediaserver.kurento.endpoint.SdpType;
...
import com.virnect.mediaserver.utils.GeoLocation;
import com.virnect.mediaserver.utils.JsonUtils;
...
@Component
public class KurentoTestSessionManager extends SessionManager {

    private static final Logger log = LoggerFactory.getLogger(KurentoTestSessionManager.class);
    ...
    public void joinRoom(Participant participant, String sessionId, Integer transactionId) {
        ...
        try {
            ...
            if (kSession == null) {
                ...
                if (sessionNotActive == null && this.isInsecureParticipant(participant.getParticipantPrivateId())) {
                    ...
                    sessionNotActive = new Session(sessionId,
                            ...
                            mediaServerProperties, recordingManager);
                }
                ...
                try {
                    if (KmsManager.selectAndRemoveKmsLock.tryLock(KmsManager.MAX_SECONDS_LOCK_WAIT, TimeUnit.SECONDS)) {
                        try {
                            ...
                            if (kSession == null) {
                                ...
                                try {
                                    ...
                                    throw new RemoteServiceException(RemoteServiceException.Code.ROOM_CANNOT_BE_CREATED_ERROR_CODE,
                        ...
                        sessionEventsHandler.onParticipantJoined(participant, sessionId, null, transactionId,
                                new RemoteServiceException(RemoteServiceException.Code.ROOM_CANNOT_BE_CREATED_ERROR_CODE, error));
                        return;
                    }
                    ...
                    log.error(error);
                    throw new RemoteServiceException(RemoteServiceException.Code.ROOM_CLOSED_ERROR_CODE, error);
                }
            }
            ...
            if (mediaServerProperties.recordingProperty.isRecording() && defaultOutputMode.equals(Recording.OutputMode.COMPOSED_QUICK_START)) {
            ...
            if (kSession.isClosed()) {
                log.warn("'{}' is trying to join session '{}' but it is closing", participant.getParticipantPublicId(),
                        sessionId);
                throw new RemoteServiceException(RemoteServiceException.Code.ROOM_CLOSED_ERROR_CODE, "'" + participant.getParticipantPublicId()
            ...
            try {
                if (kSession.joinLeaveLock.tryLock(15, TimeUnit.SECONDS)) {
                    ...
                    sessionEventsHandler.onParticipantJoined(participant, sessionId, null, transactionId,
                            new RemoteServiceException(RemoteServiceException.Code.GENERIC_ERROR_CODE, "Timeout waiting for Session lock"));
                }
            } catch (InterruptedException e) {
                log.error(
                        ...
                        participant.getParticipantPublicId(), sessionId);
                sessionEventsHandler.onParticipantJoined(participant, sessionId, null, transactionId,
                        new RemoteServiceException(RemoteServiceException.Code.GENERIC_ERROR_CODE,
            ...
            if (session.joinLeaveLock.tryLock(15, TimeUnit.SECONDS)) {
                try {
                    ...
                    if (sessionidParticipantpublicidParticipant.get(sessionId) != null) {
                        ...
                        if (p != null && this.mediaServerProperties.coturnProperty.isTurnadminAvailable()) {
                    ...
                    if (!EndReason.sessionClosedByServer.equals(reason)) {
                        ...
                        if (remainingParticipants.isEmpty()) {
                            if (mediaServerProperties.recordingProperty.isRecording()
                                ...
                                log.info("Last participant left. Starting {} seconds countdown for stopping recording of session {}",
                                        this.mediaServerProperties.recordingProperty.getRecordingAutoStopTimeout(), sessionId);
                        ...
                        } else if (remainingParticipants.size() == 1 && mediaServerProperties.recordingProperty.isRecording()
                                && MediaMode.ROUTED.equals(session.getSessionProperties().mediaMode())
                                && this.recordingManager.sessionIsBeingRecorded(sessionId)
     ...
     * @throws RemoteServiceException on error
     */
    @Override
    public void publishVideo(Participant participant, MediaOptions mediaOptions, Integer transactionId)
        ...
        if (kurentoOptions.getFilter() != null && kurentoTokenOptions != null) {
            if (kurentoTokenOptions.isFilterAllowed(kurentoOptions.getFilter().getType())) {
                ...
                RemoteServiceException e = new RemoteServiceException(RemoteServiceException.Code.FILTER_NOT_APPLIED_ERROR_CODE,
        ...
        if (sdpAnswer == null) {
            RemoteServiceException e = new RemoteServiceException(RemoteServiceException.Code.MEDIA_SDP_ERROR_CODE,
        ...
        if (this.mediaServerProperties.recordingProperty.isRecording()
    ...
    public void unpublishVideo(Participant participant, Participant moderator, Integer transactionId,
        ...
        try {
            ...
            if (!participant.isStreaming()) {
                ...
                throw new RemoteServiceException(RemoteServiceException.Code.USER_NOT_STREAMING_ERROR_CODE,
    ...
    public void subscribe(Participant participant, String senderName, String sdpOffer, Integer transactionId) {
        ...
        try {
            ...
            if (senderParticipant == null) {
                ...
                throw new RemoteServiceException(RemoteServiceException.Code.USER_NOT_FOUND_ERROR_CODE,
            ...
            if (sdpAnswer == null) {
                throw new RemoteServiceException(RemoteServiceException.Code.MEDIA_SDP_ERROR_CODE,
     ...
     *
     * @throws RemoteServiceException in case of error while creating the session
     */
    public KurentoSession createSession(Session sessionNotActive, Kms kms) throws RemoteServiceException {
    ...
    public boolean evictParticipant(Participant evictedParticipant, Participant moderator, Integer transactionId,
                                    EndReason reason) throws RemoteServiceException {
        ...
        if (evictedParticipant != null) {
            ...
            if (moderator != null && transactionId != null) {
                this.sessionEventsHandler.onForceDisconnect(moderator, evictedParticipant,
                        ...
                        new RemoteServiceException(RemoteServiceException.Code.USER_NOT_FOUND_ERROR_CODE,
    ...
    @Override
    public KurentoMediaOptions generateMediaOptions(Request<JsonObject> request) throws RemoteServiceException {
        ...
        try {
            ...
            if (kurentoFilterJson != null) {
                try {
                    ...
                    throw new RemoteServiceException(RemoteServiceException.Code.FILTER_NOT_APPLIED_ERROR_CODE,
        ...
        if (participantPrivateId != null) {
            ...
            if (participant != null) {
                if (participant.isIpcam()) {
                    throw new RemoteServiceException(RemoteServiceException.Code.USER_GENERIC_ERROR_CODE, "Stream '" + streamId
        ...
        if (participantPrivateId != null) {
            ...
            if (!publisher.isStreaming()) {
                ...
                log.warn(
                        ...
                        moderator != null ? moderator.getParticipantPublicId() : publisher.getParticipantPublicId(),
                        publisher.getParticipantPublicId(), session.getSessionId());
                throw new RemoteServiceException(RemoteServiceException.Code.EXISTING_FILTER_ALREADY_APPLIED_ERROR_CODE,
        ...
        if (!pub.isListenerAddedToFilterEvent(eventType)) {
            ...
            try {
                ...
                log.error("Request to addFilterEventListener to stream {} gone wrong. Error: {}", streamId,
                        e.getMessage());
                throw new RemoteServiceException(RemoteServiceException.Code.FILTER_EVENT_LISTENER_NOT_FOUND,
