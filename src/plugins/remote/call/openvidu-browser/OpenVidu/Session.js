...
var Session = /** @class */ (function() {
  ...
  Session.prototype.onNewMessage = function(msg) {
    ...
    if (msg.from) {
      ...
      this.ee.emitEvent('signal', [
        new SignalEvent_1.SignalEvent(this, strippedType, msg.data, undefined),
      ])
      if (msg.type !== 'signal') {
        this.ee.emitEvent(msg.type, [
          new SignalEvent_1.SignalEvent(
            this,
            strippedType,
            msg.data,
      ...
      if (!!connection.stream && connection.stream.streamId === msg.streamId) {
        ...
        switch (msg.property) {
          ...
          case 'filter':
            ...
            msg.newValue =
              Object.keys(msg.newValue).length > 0 ? msg.newValue : undefined
  ...
  Session.prototype.reconnectBrokenStreams = function() {
    ...
    for (
      var _i = 0, _a = Object.values(this.remoteConnections);
      _i < _a.length;
      _i++
    ) {
  ...
  Session.prototype.processToken = function(token, iceServer) {
    ...
    if (match) {
      ...
      this.openvidu.wsUri = 'wss://192.168.6.4:4443/media/websocket'
