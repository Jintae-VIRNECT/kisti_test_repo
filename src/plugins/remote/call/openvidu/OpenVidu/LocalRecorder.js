...
var LocalRecorder = /** @class */ (function() {
    ...
    return new Promise(function(resolve, reject) {
      try {
        ...
        if (typeof MediaRecorder.isTypeSupported === 'function') {
          ...
          logger.warn(
            'MediaRecorder#isTypeSupported is not supported. Using default codecs',
          )
        }
      ...
      _this.mediaRecorder.onstart = function() {
        logger.log(
          'MediaRecorder started (state=' + _this.mediaRecorder.state + ')',
        )
      }
      ...
      _this.mediaRecorder.onpause = function() {
        logger.log(
          'MediaRecorder paused (state=' + _this.mediaRecorder.state + ')',
        )
      }
      _this.mediaRecorder.onresume = function() {
        logger.log(
          'MediaRecorder resumed (state=' + _this.mediaRecorder.state + ')',
        )
      }
  ...
  LocalRecorder.prototype.clean = function() {
    ...
    if (
      this.state === LocalRecorderState_1.LocalRecorderState.RECORDING ||
