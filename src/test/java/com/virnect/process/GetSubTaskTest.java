...
public class GetSubTaskTest {
    ...
    @Test
    @Transactional
    public void getSubTask_InvalidTaskId_ProcessServiceException() throws Exception {
        RequestBuilder request = get("/tasks/{taskId}/subTasks", "2040");
