...
public class ContentTargetAddTest {
    ...
    public void contentTargetAdd_InvalidContentUUID_ContentServiceException() throws Exception {
        ...
        this.mockMvc.perform(request)
                .andDo(print())
                .andExpect(result -> assertTrue(result.getResponse().getContentAsString().contains("4004"))) // Content Update fail.
    ...
    public void contentTargetAdd_ContentState_ContentServiceException() throws Exception {
        ...
        this.mockMvc.perform(request)
                .andDo(print())
                .andExpect(result -> assertTrue(result.getResponse().getContentAsString().contains("4009"))) // Content deletion failed. Because it is managed. Delete the process created with this content and try again.
                .andExpect(result -> assertTrue(result.getResolvedException().getClass().isAssignableFrom(ContentServiceException.class)));
    }
    ...
    public void contentTargetAdd_DuplicateTargetData_ContentServiceException() throws Exception {
        ...
        this.mockMvc.perform(request)
                .andDo(print())
                .andExpect(result -> assertTrue(result.getResponse().getContentAsString().contains("4101"))) // Target insert fail. Because this target data already exist.
                .andExpect(result -> assertTrue(result.getResolvedException().getClass().isAssignableFrom(ContentServiceException.class)));
    }
}
