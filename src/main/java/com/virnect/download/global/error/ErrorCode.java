...
public enum ErrorCode {
    ...
    ERR_APP_UPLOAD_FILE_EXTENSION_NOT_SUPPORT(6002,"Application file upload file. Application extension not supported."),
    ...
    ERR_APP_UPLOAD_FAIL_OS_INFO_NOT_FOUND(6005, "Application file upload fail. Operation System information not found."),
    ERR_APP_UPLOAD_FAIL_PRODUCT_INFO_NOT_FOUND(6006, "Application file upload fail. Application product information not found."),
    ERR_APP_UPLOAD_FAIL_DUPLICATE_VERSION(6007, "Application file upload fail. Application version is duplicated."),
    ERR_APP_UPLOAD_FAIL_VERSION_IS_LOWER(6008, "Application file upload fail. Application version is lower then latest version duplicated."),
    ERR_APP_PACKAGE_NAME_NOT_FOUND(6009, "Application information not found."),
    ERR_APP_SIGNING_KEY_REGISTER(6010, "Application signing key registration failed. Every application found by packageName has signing key information."),
