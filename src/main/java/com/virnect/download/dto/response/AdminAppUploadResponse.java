...
public class AdminAppUploadResponse {
	...
	@ApiModelProperty(value = "앱 버전 코드", position = 2, example = "1020000")
	...
	@ApiModelProperty(value = "앱 구동 디바이스 모델(ex: SMARTPHONE_TABLET, HTM-1, HOLOLENS_2, FITT/NEXX, WINDOWS_10)", position = 4, example = "PC")
	private String deviceModel = "";
	@ApiModelProperty(value = "앱 구동 시스템 정보(ex: ANDROID, WINDOWS)", position = 5, example = "Android")
	private String operationSystem;
	@ApiModelProperty(value = "앱 패키지명", position = 6, example = "com.virnect.platform.server")
	private String packageName;
	@ApiModelProperty(value = "앱 설치 파일 주소", position = 7, example = "https://s3.url.com")
	private String appUrl = "";
	@ApiModelProperty(value = "앱 제품 정보", position = 8, example = "REMOTE")
