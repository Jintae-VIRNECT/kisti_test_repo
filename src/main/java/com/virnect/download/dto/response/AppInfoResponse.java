...
public class AppInfoResponse {
    ...
    @ApiModelProperty(value = "앱 설치파일", position = 5, example = "")
    private String appUrl = "";
    @ApiModelProperty(value = "앱 가이드파일", position = 6, example = "")
    private String guideUrl = "";
    @ApiModelProperty(value = "앱 썸네일 url", position = 7, example = "")
    private String imageUrl = "";
    @ApiModelProperty(value = "앱 릴리즈 일자", position = 8, example = "")
