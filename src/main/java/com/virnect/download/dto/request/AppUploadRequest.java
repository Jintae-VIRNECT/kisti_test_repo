...
public class AppUploadRequest {
    @ApiModelProperty(value = "앱 구동 시스템 정보(ex: ANDROID, WINDOWS)", example = "ANDORID")
    @NotBlank(message = "앱 구동 시스템 정보는 반드시 입력되어야 합니다.")
    private String operationSystem;
    @ApiModelProperty(value = "앱 제품 정보", position = 1, example = "REMOTE")
    ...
    @ApiModelProperty(value = "업로드 앱 파일", dataType = "__file", position = 3)
