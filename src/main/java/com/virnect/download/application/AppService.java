...
public class AppService {
    ...
    public ApiResponse<AppUploadResponse> applicationUploadAndRegister(AppUploadRequest appUploadRequest) {
        ...
        Optional<App> previousAppInfo = this.appRepository.getLatestVersionAppInfoByPackageName(apkMeta.getPackageName());
        ...
        if (previousAppInfo.isPresent()) {
            ...
            boolean isLowerThenLatestVersionCode = versionLowerCheck(apkMeta.getPackageName(), apkMeta.getVersionCode());
    ...
    @Transactional
    public ApiResponse<AppSigningKetRegisterResponse> registerAppSigningKey(AppSigningKeyRegisterRequest signingKeyRegisterRequest) {
        boolean hasUnRegisteredApp = appRepository.existsByPackageNameAndSignatureIsNull(signingKeyRegisterRequest.getPackageName());
        ...
        long amountOfAffectAppInfo = appRepository.registerSigningKeyByPackageName(signingKeyRegisterRequest.getPackageName(), signingKeyRegisterRequest.getSigningKey());
        ...
        List<App> updateAppList = appRepository.findByPackageNameAndSignature(signingKeyRegisterRequest.getPackageName(), signingKeyRegisterRequest.getSigningKey());
