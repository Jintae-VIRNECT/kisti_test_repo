...
public class IssueController {
    ...
    public ResponseEntity<ApiResponse<IssuesResponse>> getIssues(
        ...
        ApiResponse<IssuesResponse> issuesResponseApiResponse = this.issueService.getIssuesIn(myUUID, workspaceUUID, search, stepId, pageable.of());
...
//        }
    ...
    public ResponseEntity<ApiResponse<IssuesResponse>> getTroubleMemo(
        ...
        ApiResponse<IssuesResponse> issuesResponseApiResponse = this.issueService.getIssuesOut(myUUID, workspaceUUID, search, pageable.of());
    ...
    public ResponseEntity<ApiResponse<TroubleMemoUploadResponse>> setTroubleMemo(
        ...
        ApiResponse<TroubleMemoUploadResponse> responseMessage = this.issueService.uploadTroubleMemo(troubleMemoUploadRequest);
