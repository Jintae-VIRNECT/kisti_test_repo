...
public class SubTaskController {
    ...
    public ResponseEntity<ApiResponse<SubProcessListResponse>> getSubProcessList(
        ...
        ApiResponse<SubProcessListResponse> subProcessListResponseApiResponse = this.subTaskService.getSubProcessList(taskId, workspaceUUID, search, userUUID, filter, pageable.of());
    ...
    public ResponseEntity<ApiResponse<SubProcessesResponse>> getSubProcesses(
            ...
            , @ApiIgnore PageRequest pageable) {
        ApiResponse<SubProcessesResponse> subProcessesResponseApiResponse = this.subTaskService.getSubProcesses(workspaceUUID, taskId, search, pageable.of(), filter);
    ...
    public ResponseEntity<ApiResponse<SubProcessInfoResponse>> getSubProcess(@PathVariable("subTaskId") Long subTaskId) {
        ApiResponse<SubProcessInfoResponse> subProcessesResponseApiResponse = this.subTaskService.getSubProcess(subTaskId);
        return ResponseEntity.ok(subProcessesResponseApiResponse);
    }
    ...
    public ResponseEntity<ApiResponse<MyWorkListResponse>> getMyWorks(
        ...
        ApiResponse<MyWorkListResponse> myWorkListResponseApiResponse = this.subTaskService.getMyWorks(workspaceUUID, workerUUID, taskId, search, pageable.of());
    ...
    public ResponseEntity<ApiResponse<SubProcessesOfTargetResponse>> getSubProcessesOfTargetData(
        ...
        ApiResponse<SubProcessesOfTargetResponse> subProcessesOfTargetResponseApiResponse = this.subTaskService.getSubProcessesOfTarget(workspaceUUID, targetData, pageable.of());
