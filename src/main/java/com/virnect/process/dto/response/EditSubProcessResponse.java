...
public class EditSubProcessResponse {
    ...
    @ApiModelProperty(value = "하위 이슈수", notes = "세부 공정 하위에 이슈의 개수", position = 13, example = "3")
