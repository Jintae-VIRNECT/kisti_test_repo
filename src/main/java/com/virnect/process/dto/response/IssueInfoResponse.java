...
public class IssueInfoResponse {
	...
	@ApiModelProperty(value = "워크스페이스 식별자", notes = "워크스페이스 식별자", position = 13, example = "")
	private String workspaceUUID;

	@Builder
	public IssueInfoResponse(
		long issueId, String photoFilePath, String caption, long taskId, long subTaskId, long stepId,
		LocalDateTime reportedDate, String taskName, String subTaskName, String stepName, String workerUUID,
		String workerName, String workerProfile, String workspaceUUID
	) {
