...
public class ProcessRegisterRequest {
	...
	//타겟타입을 컨텐츠서버에서 받는 것으로 수정 >> 다시 복구
	@NotNull
	@ApiModelProperty(value = "타겟 종류", notes = "작업 타겟의 종류(QR)", required = true, position = 6, example = "QR")
	private TargetType targetType;

	@NotNull
	@ApiModelProperty(value = "타겟 종류", notes = "작업 타겟의 사이즈", required = true, position = 7, example = "10")
	...
	@NotNull
	@ApiModelProperty(value = "타겟 설정", notes = "작업 타겟 설정(duplicate, transform)", required = true, position = 9, example = "duplicate")
