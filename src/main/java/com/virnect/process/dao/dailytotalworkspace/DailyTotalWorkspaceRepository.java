 ...
 * @since 2020.04.21
 */
public interface DailyTotalWorkspaceRepository
	extends JpaRepository<DailyTotalWorkspace, Long>, DailyTotalWorkspaceCustomRepository {
	...
	List<DailyTotalWorkspace> getDailyTotalRateAtMonthWithWorkspace(
		@Param("workspaceUUID") String workspaceUUID, @Param("month") String month
	);
