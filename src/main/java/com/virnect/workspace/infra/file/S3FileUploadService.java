...
public class S3FileUploadService implements FileUploadService {
	...
	private String putS3(File uploadFile, String fileName) {
		try {
			amazonS3Client.putObject(new PutObjectRequest(bucketName, fileName, uploadFile).withCannedAcl(
	...
	public byte[] download(String fileName) throws IOException {
		GetObjectRequest rangeObjectRequest = new GetObjectRequest(bucketName, bucketResource + "/" + fileName);
