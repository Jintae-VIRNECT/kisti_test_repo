...
public enum ErrorCode {
	...
	ERR_WORKSPACE_USER_PASSWORD_CHANGE(1013,"Workspace user password change fail"),
	ERR_WORKSPACE_USER_PASSWORD_CHANGE_MEMBER_USER_NOT_FOUND(1013,"Workspace user password change fail"),
