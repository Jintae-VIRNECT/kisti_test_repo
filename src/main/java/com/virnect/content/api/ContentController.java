...
public class ContentController {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "targetType", value = "타겟 종류(QR, VTarget, VR, Image)", dataType = "string", paramType = "form", defaultValue = "QR"),
            ...
            @ApiImplicitParam(name = "targetImage", value = "타겟 이미지", dataType = "__file", paramType = "form")
    })
