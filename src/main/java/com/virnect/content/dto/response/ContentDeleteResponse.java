...
public class ContentDeleteResponse {
	...
	public ContentDeleteResponse(
		String workspaceUUID, String contentUUID, String contentName, YesOrNo shared, String uploaderUUID,
		YesOrNo converted, LocalDateTime updatedDate, String msg, Boolean result
	) {
