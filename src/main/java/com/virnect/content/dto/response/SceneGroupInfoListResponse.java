...
public class SceneGroupInfoListResponse {
    ...
    private List<SceneGroupInfoResponse> sceneGroupInfoList;

    @Builder
    public SceneGroupInfoListResponse(String contentUUID, List<SceneGroupInfoResponse> sceneGroupInfoList) {
        this.contentUUID = contentUUID;
        this.sceneGroupInfoList = sceneGroupInfoList;
    }
}
