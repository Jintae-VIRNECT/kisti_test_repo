...
public class ContentInfoResponse {
    ...
    @ApiModelProperty(value = "해당 컨텐츠가 등록된 공정 아이디", notes = "해당 컨텐츠가 등록된 공정 아이디 대한 값입니다", position = 10, example = "1")
    private long processId = 0;
    @ApiModelProperty(value = "해당 컨텐츠가 등록된 공정 이름", notes = "해당 컨텐츠가 등록된 공정 이름입니다", position = 11, example = "테스트 공정")
    private String processName = "NONE";
    @ApiModelProperty(value = "컨텐츠 생성 일자", notes = "컨텐츠 생성일자(신규 등록) 기간 정보입니다.", position = 12, example = "2020-02-15 16:32:13")
    private LocalDateTime createdDate;

    @Builder
    public ContentInfoResponse(String workspaceUUID, String contentUUID, String contentName, YesOrNo shared, int sceneGroupTotal, long contentSize, String uploaderUUID, String uploaderName, String uploaderProfile, String path, YesOrNo converted, ContentTargetResponse target, long processId, String processName, LocalDateTime createdDate) {
