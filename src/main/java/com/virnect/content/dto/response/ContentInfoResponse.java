...
public class ContentInfoResponse {
    ...
    @Builder
    public ContentInfoResponse(String workspaceUUID, String contentUUID, String contentName, YesOrNo shared, int sceneGroupTotal, long contentSize, String uploaderUUID, String uploaderName, String uploaderProfile, String path, YesOrNo converted, List<ContentTargetResponse> targets, LocalDateTime createdDate, Float targetSize) {
