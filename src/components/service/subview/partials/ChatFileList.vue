...
export default {
  ...
  data() {
    return {
      ...
      chatFileList: [
        ...
        {
          id: 'ff',
          fileName: '20200220_배출공정 스캔데이터.jpg',
          ext: 'jpg',
          checked: false,
          validDate: '2020. 05. 14.',
          fileSize: '10MB',
  ...
  watch: {
    ...
    //         this.$refs['chatFileListScrollbar'].scrollToY(
