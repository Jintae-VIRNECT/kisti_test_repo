  ...
  computed: {
    imgSrc() {
      if (this.count > 0 && this.selected) {
        return require('assets/image/ic_file_select.svg')
      } else if (this.count > 0) {
        return require('assets/image/ic_file_active.svg')
      } else {
        return require('assets/image/ic_file_default.svg')
      }
    },
  },
  methods: {
