    ...
    stage('Deploy') {
      parallel {
        stage('Develop Branch') {
          ...
          steps {
            sh 'wget http://localhost:8078/v2/api-docs -O /var/lib/jenkins/Swagger-Diff/Diff/${SERVICE_NAME}_old.json'
            ...
            sh 'wget http://localhost:8078/v2/api-docs -O /var/lib/jenkins/Swagger-Diff/Diff/${SERVICE_NAME}_new.json'
