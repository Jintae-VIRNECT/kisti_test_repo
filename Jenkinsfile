          ...
          parallel {
            ...
            stage('Develop Branch') {
              ...
              steps {
                ...
                sh 'docker run -p 7777:7777 --restart=always -d --name=rm-mediaserver rm-mediaserver'
                  ...
                  publishers: [
                    sshPublisherDesc(
                      ...
                      transfers: [
                        ...
                        sshTransfer(
                          execCommand: "docker run -p 8888:8888 --restart=always  -d --name=rm-mediaserver $aws_ecr_address/rm-mediaserver:\\${GIT_TAG}"
                        ),
                        sshTransfer(
