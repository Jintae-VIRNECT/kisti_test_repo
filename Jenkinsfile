        ...
        stage('Develop Branch') {
          ...
          steps {
            catchError() {
              ...
              sh 'docker run -p 8078:8078 --restart=always -e "SPRING_PROFILES_ACTIVE=develop" -v /data/content/contentsmanagement:/usr/app/upload -e eureka.instance.ip-address=`hostname -I | awk  \'{print $1}\'` -d --name=pf-contentsmanagement pf-contentsmanagement'
