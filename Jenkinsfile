pipeline {
        ...
        stage('Build') {
            parallel {
                stage('Develop Branch') {
                    ...
                    steps {
                        sh 'docker build -t pf-gateway -f docker/Dockerfile .'
                    }
                }
                ...
                stage('Staging Branch') {
                    ...
                    steps {
                        ...
                        sh 'docker build -t pf-gateway:${GIT_TAG} -f docker/Dockerfile .'
                    }
                }
            }
        }
            ...
            parallel {
                stage('Develop Branch') {
                    ...
                    steps {
                        ...
                        sh 'docker run -p 8073:8073 --restart=always -m 1g -e "CONFIG_SERVER=http://192.168.6.3:6383" -e "VIRNECT_ENV=develop" -d --name=pf-gateway pf-gateway'
                    ...
                    steps {
                        script {
                            docker.withRegistry("https://$aws_ecr_address", 'ecr:ap-northeast-2:aws-ecr-credentials') {
                                docker.image("pf-gateway:${GIT_TAG}").push("${GIT_TAG}")
    ...
    post {
        always {
            ...
            office365ConnectorSend webhookUrl: "https://virtualconnect.webhook.office.com/webhookb2/41e17451-4a57-4a25-b280-60d2d81e3dc9@d70d3a32-a4b8-4ac8-93aa-8f353de411ef/JenkinsCI/e79d56c16a7944329557e6cb29184b32/d0ac2f62-c503-4802-8bf9-f6368d7f39f8"
            office365ConnectorSend message: "<Your message>", status:"<Build status>", webhookUrl:'<https://virtualconnect.webhook.office.com/webhookb2/41e17451-4a57-4a25-b280-60d2d81e3dc9@d70d3a32-a4b8-4ac8-93aa-8f353de411ef/JenkinsCI/e79d56c16a7944329557e6cb29184b32/d0ac2f62-c503-4802-8bf9-f6368d7f39f8>'
        }
    }
}
