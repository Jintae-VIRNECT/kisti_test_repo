                  ...
                  publishers: [
                    sshPublisherDesc(
                      ...
                      transfers: [
                        ...
                        sshTransfer(
                          execCommand: "docker run -p 8761:8761 --restart=always -e 'CONFIG_SERVER=http://stgconfig.virnect.com' -e 'VIRNECT_ENV=staging' -e eureka.instance.ip-address=`hostname -I | awk  \'{print \$1}\'` -d --name=pf-eureka $aws_ecr_address/pf-eureka:\\${GIT_TAG}"
                        ),
                        sshTransfer(
                  ...
                  publishers: [
                    sshPublisherDesc(
                      ...
                      transfers: [
                        ...
                        sshTransfer(
                          execCommand: "docker run -p 8761:8761 --restart=always -e 'CONFIG_SERVER=http://config.virnect.com' -e 'VIRNECT_ENV=production' -e eureka.instance.ip-address=`hostname -I | awk  \'{print \$1}\'` -d --name=pf-eureka $aws_ecr_address/pf-eureka:\\${GIT_TAG}"
                        ),
                        sshTransfer(
                          execCommand: 'docker image prune -a -f'
                        )
