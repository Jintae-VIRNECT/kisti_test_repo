                  ...
                  publishers: [
                    sshPublisherDesc(
                      ...
                      transfers: [
                        ...
                        sshTransfer(
                          execCommand: "docker run -p 8078:8078 --restart=always 'CONFIG_SERVER=https://stgconfig.virnect.com' -e 'VIRNECT_ENV=staging' -e eureka.instance.ip-address=`hostname -I | awk  \'{print \$1}\'`  -v /data/content/contentsmanagement:/usr/app/upload -d --name=pf-contentsmanagement $aws_ecr_address/pf-contentsmanagement:\\${GIT_TAG}"
                        ),
                        sshTransfer(
