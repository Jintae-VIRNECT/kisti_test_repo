            ...
            parallel {
                stage('Develop Branch') {
                    ...
                    steps {
                        ...
                        sh 'docker run -p 8083:8083 --restart=always -e CONFIG_SERVER=http://192.168.6.3:6383 -e VIRNECT_ENV=develop -d -v /var/run/docker.sock:/var/run/docker.sock -v /data/recordings:/recordings --name=rm-recordserver rm-recordserver'
                        ...
                        sh 'docker run -p 18083:8083 --restart=always -e CONFIG_SERVER=http://192.168.6.3:6383 -e VIRNECT_ENV=onpremise -d -v /var/run/docker.sock:/var/run/docker.sock -v /data/recordings:/recordings --name=rm-recordserver-onpremise rm-recordserver'
                        catchError {
