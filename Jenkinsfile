                  ...
                  publishers: [
                    sshPublisherDesc(
                      ...
                      transfers: [
                        ...
                        sshTransfer(
                           execCommand: "docker run -p 8888:8888 -p 50000-50100:50000-50100/udp -e KMS_EXTERNAL_ADDRESS=3.34.209.208 -e KMS_MIN_PORT=50000 -e KMS_MAX_PORT=50100 --restart=always  -d --name=rm-mediaserver $aws_ecr_address/rm-mediaserver:\\${GIT_TAG}"
                        ),
                        sshTransfer(
                          execCommand: 'docker image prune -a -f'
                        )
