...
/**
 * See {@link com.virnect.java.client.Session#generateToken(TokenOptions)}
 */
public class TokenOptions {
	...
	/**
	 * 
	 * Builder for {@link com.virnect.java.client.TokenOptions}
	 *
	 */
	public static class Builder {

		private String data = "";
		private RemoteServiceRole role = RemoteServiceRole.PUBLISHER;
		private KurentoOptions kurentoOptions;
		 ...
		 * {@link com.virnect.java.client.TokenOptions.Builder#data(String)}
		 * property.</li>
		 ...
		 */
		public Builder role(RemoteServiceRole role) {
			this.role = role;
			return this;
		}

		/**
		 * Call this method to set a {@link com.virnect.java.client.KurentoOptions}
	...
	private TokenOptions(String data, RemoteServiceRole role, KurentoOptions kurentoOptions) {
		this.data = data;
		this.role = role;
		this.kurentoOptions = kurentoOptions;
	}
