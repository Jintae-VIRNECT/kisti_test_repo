...
/**
 * See {@link com.virnect.java.client.RemoteService#createSession(SessionProperties)}
 */
public class SessionProperties {
	...
	/**
	 * Builder for {@link com.virnect.java.client.SessionProperties}
	 */
	public static class Builder {
		...
		/**
		 * Returns the {@link com.virnect.java.client.SessionProperties} object properly
		 * configured
		 */
		 ...
		 * {@link com.virnect.java.client.RecordingProperties#outputMode()} of every
		 * recording of this session. You can easily override this value later when
		 * starting a {@link com.virnect.java.client.Recording} by calling
		 * {@link com.virnect.java.client.RecordingProperties.Builder#outputMode(Recording.OutputMode)}
		 * with any other value.<br>
		 * Default value is {@link Recording.OutputMode#COMPOSED}
		 */
		public Builder defaultOutputMode(OutputMode outputMode) {
		...
		/**
		 * Call this method to set the the default value used to initialize property
		 * {@link com.virnect.java.client.RecordingProperties#recordingLayout()} of
		 * every recording of this session. You can easily override this value later
		 * when starting a {@link com.virnect.java.client.Recording} by calling
		 * {@link com.virnect.java.client.RecordingProperties.Builder#recordingLayout(RecordingLayout)}
		 * with any other value.<br>
		 * Default value is {@link RecordingLayout#BEST_FIT}<br>
		 * <br>
		 * Recording layouts are only applicable to recordings with OutputMode
		 * {@link com.virnect.java.client.Recording.OutputMode#COMPOSED} or
		 * {@link com.virnect.java.client.Recording.OutputMode#COMPOSED_QUICK_START}
		 */
		 ...
		 * {@link com.virnect.java.client.RecordingProperties#customLayout()} of every
		 * recording of this session. You can easily override this value later when
		 * starting a {@link com.virnect.java.client.Recording} by calling
		 * {@link com.virnect.java.client.RecordingProperties.Builder#customLayout(String)}
		 * with any other value.<br>
		 * <br>
		 * 
		 * Custom layouts are only applicable to recordings with OutputMode
		 * {@link com.virnect.java.client.Recording.OutputMode#COMPOSED} (or 
		 * {@link com.virnect.java.client.Recording.OutputMode#COMPOSED_QUICK_START}) and
		 * RecordingLayout {@link com.virnect.java.client.RecordingLayout#CUSTOM}
		 */
