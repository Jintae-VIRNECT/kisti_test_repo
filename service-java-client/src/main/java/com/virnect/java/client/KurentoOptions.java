...
public class KurentoOptions {
	...
	/**
	 * 
	 * Builder for {@link com.virnect.java.client.KurentoOptions}
	 *
	 */
	public static class Builder {
		...
		/**
		 * Set value for
		 * {@link com.virnect.java.client.KurentoOptions#getVideoMaxRecvBandwidth()}
		 */
		...
		/**
		 * Set value for
		 * {@link com.virnect.java.client.KurentoOptions#getVideoMinRecvBandwidth()}
		 */
		...
		/**
		 * Set value for
		 * {@link com.virnect.java.client.KurentoOptions#getVideoMaxSendBandwidth()}
		 */
		...
		/**
		 * Set value for
		 * {@link com.virnect.java.client.KurentoOptions#getVideoMinSendBandwidth()}
		 */
		...
		/**
		 * Set value for
		 * {@link com.virnect.java.client.KurentoOptions#getAllowedFilters()}
		 */
