...
/**
 * See
 * {@link com.virnect.java.client.SessionProperties.Builder#recordingMode(RecordingMode)}
 */
public enum RecordingMode {
	 ...
	 * {@link com.virnect.java.client.RemoteService#stopRecording(String)}).
	 */
	ALWAYS,

	/**
	 * The session is not recorded automatically. To record the session, you must
	 * call {@link com.virnect.java.client.RemoteService#startRecording(String)} method.
