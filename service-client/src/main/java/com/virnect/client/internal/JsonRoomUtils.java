...
public class JsonRoomUtils {
  ...
  public static <T> T getRequestParam(Request<JsonObject> request, String paramName, Class<T> type,
    ...
    if (params == null) {
      if (!allowNull) {
        throw new RemoteServiceException(Code.TRANSPORT_REQUEST_ERROR_CODE,
  ...
  public static <T> T getResponseProperty(JsonElement result, String property, Class<T> type,
    ...
    if (!(result instanceof JsonObject)) {
      throw new RemoteServiceException(Code.TRANSPORT_RESPONSE_ERROR_CODE,
  ...
  private static <T> T getConverted(JsonElement paramValue, String property, Class<T> type,
    ...
    if (paramValue == null) {
      if (allowNull) {
        ...
        throw new RemoteServiceException(Code.TRANSPORT_ERROR_CODE, "Invalid method lacking parameter '"
            + property + "'");
      }
    }
    ...
    throw new RemoteServiceException(Code.TRANSPORT_ERROR_CODE, "Param '" + property + "' with value '"
