...
import com.virnect.remoteserviceserver.cdr.CDREventRecording;
...
import com.virnect.remoteserviceserver.kurento.endpoint.EndpointType;
...
public abstract class SessionManager {
	...
	public void closeSessionAndEmptyCollections(Session session, EndReason reason, boolean stopRecording) {
		...
		if (remoteServiceConfig.isRecordingModuleEnabled() && stopRecording
