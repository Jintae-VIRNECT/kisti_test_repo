...
import com.virnect.remoteserviceserver.recording.service.WaitForContainerStoppedCallback;
...
public class DockerManager {
	...
	public void checkDockerEnabled() throws RemoteServiceException {
		try {
			this.dockerImageExistsLocally("hello-world");
			log.info("Docker is installed and enabled");
		} catch (ProcessingException exception) {
			throw new RemoteServiceException(Code.DOCKER_NOT_FOUND, "Exception connecting to Docker daemon");
		}
	}
