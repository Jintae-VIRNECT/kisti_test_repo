...
package com.virnect.remoteserviceserver.kurento.core;
...
import com.virnect.remoteserviceserver.core.*;
import com.virnect.remoteserviceserver.core.Session;
import com.virnect.remoteserviceserver.kurento.endpoint.KurentoFilter;
import com.virnect.remoteserviceserver.kurento.endpoint.PublisherEndpoint;
import com.virnect.remoteserviceserver.kurento.endpoint.SdpType;
import com.virnect.remoteserviceserver.kurento.kms.Kms;
import com.virnect.remoteserviceserver.kurento.kms.KmsManager;
import com.virnect.remoteserviceserver.rpc.RpcHandler;
import com.virnect.remoteserviceserver.utils.GeoLocation;
import com.virnect.remoteserviceserver.utils.JsonUtils;
						...
						if (remainingParticipants.isEmpty()) {
							if (remoteServiceConfig.isRecordingModuleEnabled()
								...
								log.info(
										...
										this.remoteServiceConfig.getOpenviduRecordingAutostopTimeout(), sessionId);
