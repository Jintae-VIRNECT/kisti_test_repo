...
package com.virnect.remoteserviceserver.recording;
...
public class RecordingInfoUtils {
	...
	public RecordingInfoUtils(String infoFilePath) throws FileNotFoundException, IOException, RemoteServiceException {
		...
		try {
			...
			throw new RemoteServiceException(Code.RECORDING_FILE_EMPTY_ERROR, "The recording file is corrupted");
		}
		if (this.json.size() == 0) {
			// Recording metadata from ffprobe is an emtpy JSON
			throw new RemoteServiceException(Code.RECORDING_FILE_EMPTY_ERROR, "The recording file is empty");
		}
