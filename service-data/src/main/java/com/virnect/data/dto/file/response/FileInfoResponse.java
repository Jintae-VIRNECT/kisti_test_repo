...
public class FileInfoResponse {
    ...
    private String path;*/
    @ApiModelProperty(value = "파일 생성 일자", notes = "생성일자(신규 등록) 기간 정보입니다.", position = 7, example = "2020-02-15 16:32:13")
    private LocalDateTime createdDate; //upload date?

    @ApiModelProperty(value = "파일 만료 일자", notes = "만료일자 정보입니다.", position = 8, example = "2020-02-15 16:32:13")
